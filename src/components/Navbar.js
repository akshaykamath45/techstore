  ...
  return (
    <nav className="nav-bar">
      <NavLink to="/" className="nav-bar-item">
        <img src="https://i.postimg.cc/KjHD87m1/tech-store-logo-black-and-white.png" alt="techstore-logo" className='techstore-logo'/>
      </NavLink>
      <input
        type="text"
      ...
      <NavLink to="/cart" className="nav-bar-item">
        ...
        >
          ...
          cart.length>0 && <span className="count-badge cart-count">{cart.length}</span>
        }
      ...
      <NavLink to="/wishlist" className="nav-bar-item wishlist">
        ...
        >
          ...
          />
            ...
            {
              wishlist.length>0 && <span className="count-badge wishlist-count">{wishlist.length}</span>
            }
